...
**Technology:** This tool is written with plain JavaScript, HTML, and uses Tailwind CSS for styling (via a CDN link, since it’s outside of the Next.js build). It also uses Chart.js for graphs.
